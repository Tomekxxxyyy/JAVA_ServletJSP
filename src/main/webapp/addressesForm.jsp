<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<form action="AddAddressServlet" method="get">
		...
		<input type="text" name="city"/>Miasto</br>
		<input type="text" name="postcode"/>Kod pocztowy</br>
		<input type="text" name="street"/>Ulica</br>
		<input type="text" name="houseNumber"/>Numer domu
